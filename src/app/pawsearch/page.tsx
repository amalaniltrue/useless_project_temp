  ...
  const fallbackSearch = useCallback((q: string) => {
    ...
    const fallbackResults: SearchResultItem[] = [
      ...
      },
      {
        ...
        url: googleMapsUrl || 'https://www.google.com/maps/search/dog+parks+near+me',
        ...
        pawscriptSnippet: translateToPawScript('Dog parks agility meadow and trails'),
        category: 'Places',
        source: 'places-maps',
        rating: 4.9,
      ...
      {
        id: 'fb_3',
        title: 'Feline & Canine Clinical Nutrition Standards',
        url: 'https://www.akc.org/expert-advice/nutrition/',
        displayUrl: 'akc.org › expert-advice › nutrition',
        snippet: 'Veterinary dietary index covering high-protein treats, bone broth hydration, and toxic pantry substances to avoid.',
