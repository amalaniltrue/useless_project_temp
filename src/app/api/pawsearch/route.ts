...
const PET_KNOWLEDGE_BASE: Array<{
...
}> = [
  {
    ...
    panel: {
      ...
      audioSample: '/sounds/animals/dog/dog_play_bark.mp3',
  ...
  if (!knowledgePanel) {
    ...
    if (soundMatch) {
      knowledgePanel = {
        ...
        audioSample: soundMatch.audioParams.realAudioFile || (soundMatch.animal === 'Cat' ? '/sounds/animals/cat/cat_purr.mp3' : '/sounds/animals/dog/dog_play_bark.mp3'),
